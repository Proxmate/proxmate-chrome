        ...
        function ($scope, Chrome) {
            $scope.updateProxmateStatus = function () {
                return Chrome.getProxmateStatus(function (response) {
                    ...
                    Chrome.getPrivacyStatus(function (response) {
            ...
            $scope.togglePrivacy = function () {
                if ($scope.subscription_status == 'subscription_expired') {
                    ...
                    var newStatus = !$scope.privacyStatus;
                }
                return Chrome.setPrivacyStatus(newStatus, function () {
                    return $scope.updateProxmateStatus();
                });
            };
            $scope.toggleMalware = function () {
                if ($scope.subscription_status == 'subscription_expired') {
                    newStatus = false;
                } else {
